...
public class Main {
    ...
    public static void main(String[] args) {
        String url = "jdbc:sqlserver://localhost:51828;databaseName=E1Phanna;encrypt=false;trustServerCertificate=true";
        String username = "Phanna";
        String password = "Phyry93";
